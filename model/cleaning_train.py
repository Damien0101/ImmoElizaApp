...
df.to_csv('dataset_for_model.csv', index=False)
...
y: np.ndarray = np.arraydf(['Price']).reshape(-1, 1)
...
model: CatBoostRegressor = CatBoostRegressor(**params, n_estimators=2662, loss_function='MAE')
